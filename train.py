...
def load_data(traindir, valdir, args):
    ...
    if args.cache_dataset and os.path.exists(cache_path):
        ...
        dataset = IrisDataset([traindir], transform=presets.ClassificationPresetTrain(
    ...
    if args.cache_dataset and os.path.exists(cache_path):
        ...
        dataset_test = IrisDataset([valdir], transform=preprocessing, image_set="test")
